...
//Yearly Expense
$userid=$_SESSION['detsuid'];
$query6=mysqli_query($con,"select sum(BudgetCost)  as totalbalance from budget where UserId='$userid';");
$result6=mysqli_fetch_array($query6);
$sum_total_balance=$result6['totalbalance'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4>Total Budget</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $sum_total_balance;?>" ><span class="percent"><?php if($sum_total_balance==""){
echo "0";
} else {
echo $sum_total_balance;
}
...
$userid=$_SESSION['detsuid'];
 $monthdate=  date("Y-m-d", strtotime("-1 month")); 
$crrntdte=date("Y-m-d");
$query7=mysqli_query($con,"select sum(BudgetCost)  as monthlybudget from budget where ((BudgetDate) between '$monthdate' and '$crrntdte') && (UserId='$userid');");
$result7=mysqli_fetch_array($query7);
$sum_monthly_budget=$result7['monthlybudget'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4>Last 30day's Budget</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $sum_monthly_budget;?>" ><span class="percent"><?php if($sum_monthly_budget==""){
echo "0";
} else {
