...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="https://kokdictionary.com/tiprazcoderz.png" class="img-responsive" alt="">
            </div>
...
?>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
             ...
             <li class="active"><a href="budget.php"><em class="fa fa-user-plus">&nbsp;</em>Add Budget</a></li>
             <li class="active"><a href="check-budget.php"><em class="fa fa-check-square">&nbsp;</em>Budget Report</a></li>
